...
class Optimizer:
	...
	def reduce(ast):
		...
		elif isinstance(ast,Subscript): return Subscript(Optimizer.reduce(ast.expr),ast.subs);
	...
	def negation(ast):
		...
		elif isinstance(ast,Subscript): return Subscript(Optimizer.negation(ast.expr),ast.subs);
